...
export default function CommentFillable(props: CommentFillableProps) {
    const url = API_URL + COMMENT + 'add/';
        ...
        axios.post(url + Token.jti, body, {
            ...
            .then(response => {
                if (response.data.Status == 0) {
                    ...
                    console.log(response.data.Status)
                    showMessage({
                        message: 'Problem z dodaniem komentarza: '+response.data.Message,
                        type: 'info',
                        backgroundColor: COLORS.second,
                        color: COLORS.main,
                    });
                    ...
                    <View style={styles.row}>
                        <View style={styles.row2}>
                            ...
                            <View style={styles.partRow2}>
                                <PressableStar onChangeScore={CallBack}></PressableStar>
                            </View>
                        </View>
                        <View>

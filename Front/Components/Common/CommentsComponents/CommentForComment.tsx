...
const CommentForComment = forwardRef<ChildComponentHandles, CommentProps>(({commentUrl}, ref) => {
                    ...
                    return (
                        <View key={i}>
                            <View style={styles.row}>
                                ...
                                <View style={editable[i] ?
                                    styles.Editable : styles.Normal}>
                                    ...
                                    {editable[i] ?
                                        ...
                                        <TouchableOpacity disabled={!store.getState().isLoggedIn} onPress={() => {
                                            ...
                                            setModalVisible(true)
                                                          ...
                                                          style={styles.button}><Text
                                            style={styles.buttonText}>Odpowiedz</Text></TouchableOpacity>}
                                </View>
                                <View>
...
export default CommentForComment;
